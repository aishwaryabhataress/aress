...
$date = date("Y-m-d");
$query = "INSERT INTO salesforce.Loan_Application__c(Applicant_Name__c, Birth_Date__c, Age__c, Address__c, Email_Id__c, Mobile__c,Name, Loan_Type__c, Loan_Amount__c,Application_Submission_Date__c,Annual_Income__c) VALUES('$_POST[firstname]','$_POST[bday]','$_POST[age]', '$_POST[address]','$_POST[emailaddress]','$_POST[usrtel]','$_POST[loanname]','$_POST[loantype]','$_POST[amount]','$date','$_POST[income]');";
