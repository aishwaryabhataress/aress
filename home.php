...
<div class="mySlides fade">
  ...
  <img src="http://www.jucbwai.com/images/Vehicle-loan.jpg" style="width:100%">
	<div style="display: inline-block; width:30%;">	<button class="bttn" onclick="loanapplication.php">Car loan</button>  </div>
	<div style="display: inline-block; width:30%; margin-left: -10px;"> <button class="bttn" onclick="loanapplication.php">Bike loan</button> </div>
