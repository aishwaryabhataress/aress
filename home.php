...
<div class="mySlides fade">
  ...
  <img src="http://www.jucbwai.com/images/Vehicle-loan.jpg" style="width:100%">
	<div style="display: inline-block; width:50%;">	<button >Car loan</button>  </div>
	<div style="display: inline-block; width:50%; margin-left: -100px;"> <button >Bike loan</button> </div>
