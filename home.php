...
<a href="index.php"><button class="button" type="logout" name="action" value="logout" style="text-align:center; float:right; background-color:#04C5F9; color:white;">Log Out</button>
	</div>
</div>
<br><br><br>
<ul>
